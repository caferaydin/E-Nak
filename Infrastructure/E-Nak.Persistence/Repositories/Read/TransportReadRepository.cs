...
{
    public class TransportReadRepository : ReadRepository<Transport>, ITransportReadRepository
    {
        public TransportReadRepository(MsSqlDbContext context) : base(context)
        {
        }
    }
}
